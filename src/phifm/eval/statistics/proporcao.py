...
def binomial_exata_bicaudal(ganha_a: int, ganha_b: int) -> dict:
    ...
    A mesma conta decide a comparação entre encoders (recall@1 por item, pelo
    `hibrido.mcnemar_em`) e entre composições do T1b. Até a junção com o branch
    do Mac (2026-09-16) havia duas cópias dela. Duas cópias de um teste
